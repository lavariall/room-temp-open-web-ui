"""
Web Application Module for Room Temperature Dashboard.
"""
...
async def read_root(request: Request):
    ...
    for room_name, result in zip(ROOMS, results):
        # Result string format is usually:
        # "Climate data for {room_name}: {json_content}" or "Error..."
        # We need to parse this slightly brittle string from the Bridge,
        # or better yet, refactor Bridge.
        # We need to parse this slightly brittle string from the Bridge,
    ...
    return templates.TemplateResponse(
        request=request, name="index.html", context={"rooms": room_data}
    )
    ...
    try:
        ...
        return {
            "response": (
                ...
                "But I can tell you I am monitoring the rooms."
            )
        }
